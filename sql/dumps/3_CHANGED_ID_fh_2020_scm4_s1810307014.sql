...
INSERT INTO `article` (`id`, `categoryId`, `caption`) VALUES
(1, 1, 'Lenovo 1020'),
(2, 1, 'HP 999'),
(3, 2, 'Apfel'),
(4, 2, 'Banane'),
...
INSERT INTO `article_shoppinglist` (`id`, `shoppingListId`, `articleId`, `quantity`, `maxPrice`) VALUES
(1, 1, 1, 12, '23.00'),
(2, 1, 2, 1, '10.00'),
(3, 1, 3, 3, '34.00'),
(4, 2, 4, 5, '6.00'),
...
--
-- AUTO_INCREMENT for table `article_shoppinglist`
--
ALTER TABLE `article_shoppinglist`
...
--
ALTER TABLE `article_shoppinglist`
  ADD CONSTRAINT `orderedBooks_ibfk_1` FOREIGN KEY (`shoppingListId`) REFERENCES `shoppinglist` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `orderedbooks_ibfk_2` FOREIGN KEY (`articleId`) REFERENCES `article` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
